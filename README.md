# Spring Boot + Hibernate Ehcache [![Build Status](https://travis-ci.org/hendisantika/spring-boot-ehcache.svg)](https://travis-ci.org/hendisantika/spring-boot-ehcache)
